...
import com.project.homework_2.presenters.UsersPresenter
import com.project.homework_2.R
import com.project.homework_2.adapters.UsersAdapter
...
class UsersFragment: ListFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listAdapter = UsersAdapter(view.context, R.layout.user_list_item, UsersPresenter.users)
    }
}